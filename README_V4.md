...
V4 is not yet available for public download.

In the meantime, you can download the latest stable release of **VibeCast V3**:

👉 [**Download VibeCast V3**](https://github.com/Panther4242/VibeCast-V3/releases/latest)
